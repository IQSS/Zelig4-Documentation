...
\begin{Schunk}
\begin{Sinput}
RRR> z.out1 <- zelig(vote ~ race + educate, model = "probit.gee", id = "cluster", data = sorted.turnout, robust = TRUE, corstr = "stat_M_dep", Mv=3)
\end{Sinput}
\end{Schunk}
...
\begin{Schunk}
\begin{Sinput}
RRR> z.out2 <- zelig(vote ~ race + educate, model = "probit.gee", id = "cluster", data = sorted.turnout, robust = TRUE, corstr = "fixed", R=corr.mat)
\end{Sinput}
\end{Schunk}
