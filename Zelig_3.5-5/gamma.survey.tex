...
\begin{Schunk}
\begin{Sinput}
RRR> z.out1 <- zelig(api00 ~ meals + yr.rnd, model = "gamma.survey",  
...
\begin{Schunk}
\begin{Sinput}
RRR> z.out2 <- zelig(api00 ~ meals + yr.rnd, model = "gamma.survey", strata=~stype, fpc=~fpc, data = apistrat)
\end{Sinput}
\end{Schunk}
...
\begin{Schunk}
\begin{Sinput}
RRR> jk1reps <- jk1weights(psu=apistrat$dnum)
\end{Sinput}
\end{Schunk}
...
\begin{Schunk}
\begin{Sinput}
RRR> z.out3 <- zelig(api00 ~ meals + yr.rnd, model = "gamma.survey", data = apistrat, 
...
\begin{Schunk}
\begin{Sinput}
RRR> x.low <- setx(z.out3, meals= quantile(apistrat$meals, 0.2))
RRR> x.high <- setx(z.out3, meals= quantile(apistrat$meals, 0.8))
\end{Sinput}
\end{Schunk}
Generate first
