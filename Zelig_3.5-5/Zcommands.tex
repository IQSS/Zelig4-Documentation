...
exact posterior and also allows for priors.  
   ...
   regression (\Sref{ls.net}) is similar to least squares regression
...
exact posterior and also allows for priors. 
  ...
  \item {\tt "netlogit"}: The {\it network logistic}
   regression (\Sref{logit.net}) is similar to logistic regression
...
\item {\tt ei.RxC}: The $R \times C$ {\sc ei} model (see \Sref{ei.RxC})
