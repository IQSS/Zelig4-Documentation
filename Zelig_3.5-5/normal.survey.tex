...
\begin{Schunk}
\begin{Sinput}
RRR> z.out1 <- zelig(api00 ~ meals + yr.rnd, model = "normal.survey",  weights=~pw,
+ data = apistrat) 
\end{Sinput}
\end{Schunk}
...
\end{Sinput}
\end{Schunk}
\includegraphics{vigpics/normal-ExistingPlot}
\end{center}
...
\begin{Schunk}
\begin{Sinput}
RRR> z.out2 <- zelig(api00 ~ meals + yr.rnd, 
...
\begin{Schunk}
\begin{Sinput}
RRR> s.out3<- sim(z.out3, x=x.low, x1=x.high) 
\end{Sinput}
\end{Schunk}
\begin{Schunk}
\begin{Sinput}
...
\end{Sinput}
\end{Schunk}
\includegraphics{vigpics/normal-ReplicatePlot}
\end{center}
